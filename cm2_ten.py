...
def test_cm2_vio10():
    ...
    test_params = {
        "name": "CM2 - Violacein 10 target sequences",
        "id": "cm2-vio10",
        "targets": {
            "extension": ".seq",
#            "sequences_path": f"{TEST_DIR}//data/Imperial/src/violacein-basic-ass/output/",
            "sequences_path": f"/data/Imperial/src/violacein-basic-ass/output/",
            "seq_dir_names": ["30-30-31-32-64/"],
        },
