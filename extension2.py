...
def addition(es, template_size):
    ...
    # target_json_file = "/data/Imperial/src/matching/targets/target_lycopene_sanger_A.json"
    # target_json_file = "/data/Imperial/src/matching/targets/target_lycopene_sanger_B.json"
    target_json_file = (
        "/data/Imperial/src/matching/targets/target_lycopene_sanger_C.json"
    )
