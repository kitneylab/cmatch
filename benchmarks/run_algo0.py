...
def test_algo0_target_1_candidate_1():
    ...
    test_params = {
        ...
        "candidates": "/data/Imperial/src/matching/templates/template_vio_one.json",
        "nbloop": 10,
    }
...
def test_algo0_target_1_candidate_10():
    ...
    test_params = {
        ...
        "candidates": "/data/Imperial/src/matching/templates/template_vio_ten.json",
        "nbloop": 10,
    }
...
def test_algo0_target_1_candidate_100():
    ...
    test_params = {
        ...
        "candidates": "/data/Imperial/src/matching/templates/template_vio_100.json",
        "nbloop": 1,
    }
...
def test_algo0_iupac():
    ...
    test_params = {
        "name": "Algo0 - 1 Target IUPAC - 1 Candidates",
        "id": "target-IUPAC-candidate-1",
        "targets": {
            "extension": ".seq",
            "sequences_path": "/data/Imperial/src/violacein-basic-ass",
            "seq_dir_names": ["output/iupac/"],
        },
        "candidates": "/data/Imperial/src/matching/templates/template_vio_one.json",
        "nbloop": 1,
    }
