...
def test_cm2_vio_hard_1vsAll_th75():
    """
    Test CM_2
    Violacein
    1 vs All 
    ...
    test_params = {
        "name": "CM_2: Violacein - 1 vs All - Hard B0030..B0030 - Threshhold: 0.75",
        "id": "vio-1-hard-1vsAll-B0030-B0030-B0030-B0030-B0030-th75",
        "targets": {
            "extension": ".seq",
