...
from extension_cat import reconstruct_slices, addition
...
def iter_all_seq(
    ...
    for slice in slices:
        ...
        for f in seq_filenames:
            ...
            print("Target sequence (slice) name: ", f.name.split(".")[0])
            if f.match(pattern):
                order_of_targets_names.append(f.name.split(".")[0])
                order_of_targets_paths.append(f)

    print("ORDER of targets:", order_of_targets_paths)
    ...
    for filename in order_of_targets_paths:
        ...
        if LYCOPENE:
            ...
            print("Primer(Slice):", primer)
            if primer == "tu01":
                libs_to_match = libs["TU-01"]
            elif primer == "tu02":
                libs_to_match = libs["TU-02"]
            elif primer == "tu03":
                libs_to_match = libs["TU-03"]
            elif primer == "tu04":
                libs_to_match = libs["TU-04"]
            elif primer == "tu05":
                libs_to_match = libs["TU-05"]
            elif primer == "tu06":
                libs_to_match = libs["TU-06"]
            elif primer == "tu07":
                libs_to_match = libs["TU-07"]
            elif primer == "tu08":
                libs_to_match = libs["TU-08"]
            elif primer == "tu09":
                libs_to_match = libs["TU-09"]
            elif primer == "tu10":
                libs_to_match = libs["TU-10"]
            elif primer == "tu11":
                libs_to_match = libs["TU-11"]
            elif primer == "tu12":
                libs_to_match = libs["TU-12"]
            elif primer == "tu13":
                libs_to_match = libs["TU-13"]
            elif primer == "tu14":
                libs_to_match = libs["TU-14"]
            elif primer == "tu15":
                libs_to_match = libs["TU-15"]
            else:
                raise OSError("Primer not found", sq.name)
