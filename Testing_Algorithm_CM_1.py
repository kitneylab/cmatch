...
def test_algo1_1_target_hard_th75():
    ...
    test_params = {
        ...
        "targets": {
            ...
            "seq_dir_names": ["rbs_one_hard/"],
        },
        "candidates": f"{TEST_DIR}/templates/template_violacein_02.json",
        "nbloop": 10,
        "threshold": 0.75,
    }
...
def test_algo1_1_target_easy_th99():
    ...
    test_params = {
        ...
        "candidates": f"{TEST_DIR}/templates/template_violacein_02_one_easy.json",
        "nbloop": 10,
        "threshold": 0.99,
    }
...
def test_algo1_1_target_1to1_hard_th75():
    ...
    test_params = {
        ...
        "candidates": f"{TEST_DIR}/templates/template_violacein_02_one_hard.json",
        "nbloop": 10,
        "threshold": 0.75,
    }
